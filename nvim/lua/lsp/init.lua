local on_attach = function(client, bufnr)
    ...
    buf_set_keymap('n', 'gci', "<cmd>lua require'telescope.builtin'.lsp_incoming_calls{}<CR>", opts)
    buf_set_keymap('n', 'gco', "<cmd>lua require'telescope.builtin'.lsp_outgoing_calls{}<CR>", opts)
